...
export function GradientOrbs() {
  return (
    <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      />
      <motion.div
        className="absolute right-[-6rem] top-1/3 h-[28rem] w-[28rem] rounded-full opacity-30 blur-3xl"
        style={{
          background:
      ...
      />
      <motion.div
        className="absolute bottom-[-8rem] left-1/3 h-[26rem] w-[26rem] rounded-full opacity-30 blur-3xl"
        style={{
          background:
